  ...
  <section id="clients">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm">
          <a href="https://open.spotify.com/album/3tyk99wfmyyDSRqFoS3JYE?si=EmrWIjYORLKvDw_jGA3F5w" target="_blank" rel="noreferrer">
            <figure class="figure">
        ...
        <div class="col-sm">
          <iframe title="Featured Artist" style="border-radius:12px" src="https://open.spotify.com/embed/album/3tyk99wfmyyDSRqFoS3JYE?utm_source=generator&theme=0" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"><a href="https://open.spotify.com/album/4IHmE2b2Hon9pb01FTyUgw?si=aOTkWps0QPu_Q4oWOsWPDw">Bo Randall - Cascade Highway</a></iframe>
        </div>
      </div>
    </div>
    <br /><br />
