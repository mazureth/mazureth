...
<? include('./head-nav.php'); ?>
  ...
  <div class="container-fluid">
    ...
    <section id="gear">
      <h1 class="text-center">GEARL LIST</h1>
      <div id="accordion">
          ...
          <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion">
            <div class="card-body">
              <ul>
                ...
                <li>Custom '72 Thinline Telecaster</li>
                <li>ESP LTD M207 (7 String)</li>
                ...
                <li>Oscar Schmidt Aloha Tenor Ukelele</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordion">
            <div class="card-body">
              <ul>
                <li>EVH 5150</li>
                <li>Marshall Lead 1950A</li>
                <li>1974 Fender Twin Reverb</li>
